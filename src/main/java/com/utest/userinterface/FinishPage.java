...
public class FinishPage extends PageObjectt{
        ...
        public static final Target NAMEFINISH_PAGE = Target.the("Para confirmar que hicimos el registro correctamente").located(By.xpath("//*[@id='mainContent']/div/div/div[1]/div/h1"));
